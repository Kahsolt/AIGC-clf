...
def get_app_resnet() -> ResNetForImageClassification:
    return get_app('artfan123#resnet-18-finetuned-ai-art')


def get_app_resnet_ft() -> ResNetForImageClassification:
    return get_app('kahsolt#resnet-ft')


def get_app_resnet_hf() -> ResNetForImageClassification:
    return get_app('kahsolt#resnet-hf')
